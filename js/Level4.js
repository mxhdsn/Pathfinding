class Level4 extends PathFindingScene {
    ...
    collideEnemy(player, enemySprite) {
        ...
        this.gameOver = this.add.text(200, 870, 'GAME OVER', {
            fontSize: '300px'
        })
        this.gameOver.setDepth(3)
        this.menuButton = this.add.text(800, 1200, 'RETURN', {
            fontSize: '150px'
        })
    ...
    update(time, delta) {
        ...
        if(this.jewelsCollected === 4){
            ...
            this.win = this.add.text(375, 870, 'YOU WIN', {
                fontSize: '300px'
            })
            this.win.setDepth(3)
            this.menuButton2 = this.add.text(800, 1200, 'RETURN', {
                fontSize: '150px'
            })
            this.menuButton2.setDepth(3)
            this.menuButton2.setInteractive({ useHandCursor: true })
            this.menuButton2.on('pointerdown', () => this.scene.start('MenuScene'))
        }
    }
